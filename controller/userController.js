...
export const register = catchAsyncErrors(async (req, res, next) => {
  if (!req.files || Object.keys(req.files).length === 0) {
    return next(new ErrorHandler("Avatar Required!", 404));
  }
  ...
  const newUser = await User.create({
    ...
    resume: {
      public_id: cloudinaryResponseResume.public_id, // Set your cloudinary public_id here
      url: cloudinaryResponseResume.secure_url, // Set your cloudinary secure_url here
    },
  });
